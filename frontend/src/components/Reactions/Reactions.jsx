	...
	return (
		<>
			<div
				...
				<div style={{ display: "flex", alignItems: "center" }}>
					...
					<span style={{ fontSize: 12, marginLeft: "0.5em" }}>
						{props?.info?.claps?.length || 0} claps
					</span>
					<FaRegComment
						style={{
							transform: "scale(-1, 1)",
					...
					/>
					<span style={{ fontSize: 12, marginLeft: "0.5em" }}>
						{props.info.reviewSize} Responses
					</span>
				</div>
			...
			<div style={{ marginTop: 50, marginBottom: 20 }}>
				...
				<textarea
					className='mb-2'
					value={props.info.textValue}
					onChange={props.handleReviewChange}
					style={{ width: "100%", padding: 20 }}
				/>
				<Button onClick={props.handleReviewSubmit} variant='success'>
					Send
				</Button>
			</div>
		</>
